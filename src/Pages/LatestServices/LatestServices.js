...
const LatestServices = () => {
    ...
    return (
        <div>
            <h1 className="text-5xl font-semibold text-center mt-40">Our Services</h1>
            <div className = "container  mx-auto grid grid-rows-1  md:grid-cols-2 lg:grid-cols-3 sm:grid-cols-1 gap-4 mt-5 mb-60 " >
                {
